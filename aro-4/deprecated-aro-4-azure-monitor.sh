...
# Get the latest installation scripts (downloads enable-monitoring.sh):
...
export azureAroV4ClusterResourceId=""
export logAnalyticsWorkspaceResourceId=$ARO_LOGS_WORKSPACE_ID
